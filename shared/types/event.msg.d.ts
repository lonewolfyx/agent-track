...
export interface CodexEventAgentMessagePayload {
    ...
    memory_citation?: Record<string, unknown>
}
...
export interface CodexEventSessionConfiguredPayload {
    ...
    active_permission_profile?: Record<string, unknown>
    cwd: string
    reasoning_effort?: string
    initial_messages?: Array<Record<string, unknown> & { type: string }>
    network_proxy?: {
        http_addr: string
        socks_addr: string
    }
...
export interface CodexEventExecApprovalRequestPayload {
    ...
    cwd: string
    reason?: string
    network_approval_context?: Record<string, unknown>
    proposed_execpolicy_amendment?: string[]
    proposed_network_policy_amendments?: Array<Record<string, unknown>>
    additional_permissions?: Record<string, unknown>
    available_decisions?: Array<Record<string, unknown> | string>
    parsed_cmd: Array<Record<string, unknown>>
}
...
export interface CodexEventStreamErrorPayload {
    type: 'stream_error'
    message: string
    codex_error_info?: Record<string, unknown> | string
